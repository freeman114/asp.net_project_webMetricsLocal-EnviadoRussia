...
namespace webMetrics.Models.DTO
{
    public class InfluencersResumoFree
    {
        ...
        public List<InstaMentions> LstInstaMidias { get; set; } = new List<InstaMentions>() { new InstaMentions() { Engagemer = 0 } };
        ...
        public List<PeriodoValor> LstValoresMeses { get; set; }
        public List<PeriodoValor> LstValoresMesesP { get; set; }
        public List<PeriodoValor> LstValoresMesesO { get; set; }
        ...
        public object Powerful { get; internal set; } = "0";

        public double mediaValoresMeses { get; set; }
        public double mediaValoresMesesP { get; set; }
        public double mediaValoresMesesO { get; set; }
    }
}